...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	walkingSpeedMSec := w.meanSpeed() * KmHInMsec
	heightM := w.Height / CmInM
	return (CaloriesWeightMultiplier*w.Weight + (math.Pow(walkingSpeedMSec, 2)/heightM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
